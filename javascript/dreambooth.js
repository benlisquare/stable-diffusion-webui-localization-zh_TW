//更新翻譯時，複製'/json/zh_TW/extensions/tooltips/Dreambooth.json'內容至'zh_TW_db_titles'。
const zh_TW_db_titles = {
  "API Key": {
    key: "API 金鑰",
    tooltip:
      "用於保護 Web API。單擊右側的刷新按鈕以（重新）生成您的密鑰，單擊垃圾桶圖標將其刪除。",
  },
  "AdamW Weight Decay": {
    key: "AdamW 權重衰減",
    tooltip:
  ...
  "Generate Classification Images Using txt2img": {
    key: "使用 txt2img 生成分類圖",
    tooltip: "使用源檢查點和 TXT2IMG 生成類圖像。",
  },
  ...
  "Lora Text Learning Rate": {
    key: "LoRA Text Encoder學習率",
    tooltip: "用於訓練LoRA Text Encoder的學習速率。常規學習速率被忽略。",
  },
  "Lora Text Weight": {
    key: "LoRA 文本權重",
    tooltip: "在創建模型時應該將多少LoRA權重應用於文本編碼器。",
  },
  ...
  "Shuffle After Epoch": {
    ...
    tooltip:
      "啟用後，將在第一個 epoch 後對數據集進行洗牌。這將啟用文本編碼器訓練和潛在緩存（更多 VRAM）。",
  },
  "Shuffle Tags": {
    key: "Shuffle After Epoch",
    tooltip:
  ...
  "Train Text Encoder": {
    ...
    tooltip: "啟用此功能將提供更好的結果和可編輯性，但VRAM更高。",
  },
  Train: {
    key: "訓練",
    tooltip: "開始訓練。",
  ...
  "Use EMA": {
    key: "使用EMA",
    tooltip: "啟用此功能可提供更好的結果和編輯性，但成本更高的 VRAM。",
  },
